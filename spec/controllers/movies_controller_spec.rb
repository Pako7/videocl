  ...
  login_user
   ...
   describe "GET #make_a_rent" do
    ...
    it "renders the make_a_rent template" do
      get :make_a_rent
      expect(response).to render_template("make_a_rent")
    end
   end

   describe "GET #finalize_rent" do
    it "get json format " do
      get :finalize_rent, format: :json
